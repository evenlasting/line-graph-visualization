...
public class paint extends JFrame{
	...
	static public int [] interLine =new int [100];   //交线
	static public point [] split =new int [100];	//离点
	static public int [] splitLine =new int [100];  //相离的线
	
	static Vector<LinkedList<Integer>> v=new Vector<LinkedList<Integer>>();
...
//		System.out.println("111");
		...
		for (int i=0;i<lineNum;i++) lastpoint[i]=new point();
		input.getdata();
		//init
